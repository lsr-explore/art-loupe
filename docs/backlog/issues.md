...
Snapshot of `lsr-explore/art-loupe` open issues taken **2026-09-06**.
...
- Open issues: **10** — **1** epics, **6** filed under an epic, **3** unparented
...
| # | Title | Priority | Status |
| --- | --- | --- | --- |
| [#22](https://github.com/lsr-explore/art-loupe/issues/22) | data: storage objects outlive their rows, so artist deletion is not complete | P1 | Backlog |
