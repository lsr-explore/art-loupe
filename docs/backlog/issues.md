...
Snapshot of `lsr-explore/art-loupe` open issues taken **2026-09-14**.
...
| --- | --- | --- | --- |
| [#56](https://github.com/lsr-explore/art-loupe/issues/56) | product: the acknowledgement gate states none of FR-807's three commitments, and never asks about rights in the photograph | P0 | Backlog |
...
| [#66](https://github.com/lsr-explore/art-loupe/issues/66) | python: .env.example documents settings nothing reads | P3 | Backlog |
