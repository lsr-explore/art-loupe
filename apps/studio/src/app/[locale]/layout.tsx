      ...
      <body className="flex min-h-full flex-col">
        ...
        >
          <NextIntlClientProvider messages={messages}>
            <AppShell
              // "Companion sections" beats the shared "Sections" when the surface
              // has a name of its own; the shell takes labels as props precisely so
              // an app can be more specific than the default.
              labels={shellLabels(translate, { sidebarLabel: translate('nav.label') })}
              linkComponent={Link}
